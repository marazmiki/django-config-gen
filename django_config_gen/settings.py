...
BUILTIN_CONTEXT_PROCESSORS = getattr(s, 'CONFIG_GEN_DEFAULT_CONTEXT_PROCESSORS', (
    'django_config_gen.context_processors.default',
    'django_config_gen.context_processors.host',
))

# Custom context processors
CUSTOM_CONTEXT_PROCESSORS = getattr(s, 'CONFIG_GEN_CONTEXT_PROCESSORS', ())

#
FILE_TEMPLATES = getattr(s, 'CONFIG_GEN_FILE_TEMPLATES', ())

CONTEXT_PROCESSORS = tuple(list(BUILTIN_CONTEXT_PROCESSORS) + list(CUSTOM_CONTEXT_PROCESSORS))